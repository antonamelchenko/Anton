//импортируем бибилиотеки, функции и компоненты
...
const SignUp = () => {
  ...
  //с помощью деструкторизации импортируем функции из нашего кастомного хука http.hook.js
